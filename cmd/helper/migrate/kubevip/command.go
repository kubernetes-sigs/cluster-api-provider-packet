...
import (
	...
	"sigs.k8s.io/cluster-api-provider-packet/cmd/helper/migrate/kubevip/migrator"
...
func (c *Command) Command() *cobra.Command {
	return &cobra.Command{ //nolint:exhaustivestruct
		Use:   "kube-vip",
		Short: "kube-vip migration utility for CAPP",
...
func (c *Command) RunE() error {
	...
	m, err := ui.NewModel("CAPP kube-vip Migration", migrator, !c.ToolConfig.NoTUI)
	if err != nil {
		return err
	}
