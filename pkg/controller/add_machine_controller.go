...
//+kubebuilder:rbac:groups=packet.k8s.io,resources=packetmachineproviderspecs;packetmachineproviderstatuses,verbs=get;list;watch;create;update;patch;delete
func init() {
